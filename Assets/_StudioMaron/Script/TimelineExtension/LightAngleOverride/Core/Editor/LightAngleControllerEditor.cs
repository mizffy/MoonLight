...
/// <summary>
/// Light Angle Controllerのエディタ拡張
/// 選択されたOperation Modeによって表示する変数を変える
/// </summary>
namespace StudioMaron
{
    [CustomEditor(typeof(LightAngleController))]

    public class LightAngleControllerEditor : Editor
    {
        public override void OnInspectorGUI()
        {
            ...
            LightAngleController obj = target as LightAngleController;

            EditorGUILayout.Space(10);
            EditorGUILayout.LabelField("====== Operation Mode ========================================");
            ...
            obj.reference = EditorGUILayout.ObjectField("Reference", obj.reference, typeof(LightAngleReference), true) as LightAngleReference;


            // Inspectorで値が変更された時の処理
            if (EditorGUI.EndChangeCheck())
                if (target is LightAngleController)
                    obj.OnValidate();

            // Undoに登録
            Undo.RecordObject(obj, "Light Angle Controller");
