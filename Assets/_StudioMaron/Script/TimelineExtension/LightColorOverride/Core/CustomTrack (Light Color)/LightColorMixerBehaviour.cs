...
{
    public class LightColorMixerBehaviour : PlayableBehaviour
    {
        public TimelineClip[] Clips { get; set; }
        public PlayableDirector Director { get; set; }
        public LightColorController TrackBinding { get; set; }
        ...
        {
            var lightColorController = playerData as LightColorController;
            ...
            for (int i = 0; i < Clips.Length; i++)
            {
                ...
                if (clipProgress >= 0.0f && clipProgress <= 1.0f)
                {
                    ...
                    param.enableBeatFlash = behaviour.enableBeatFlash;
                    param.flashCycleDuration = behaviour.flashCycleDuration;
